...
class TypedEntityRelationshipExtractor(dspy.Module):
    def __init__(self, lm: dspy.LM = None, reasoning: dspy.OutputField = None, max_retries: int = 3):
        super().__init__()
        self.lm = lm
    ...
    def forward(self, input_text: str) -> dspy.Prediction:
        ...
        entities = [
            ...
            for entity in extraction_result.entities_relationships if isinstance(entity, Entity)
        ]
        ...
        relationships = [
            ...
            for relationship in extraction_result.entities_relationships if isinstance(relationship, Relationship)
        ]
