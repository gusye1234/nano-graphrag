...
WORKING_DIR = "nano_graphrag_cache_using_pg_as_vectorDB"
dsn = os.environ.get("POSTGRES_CONNECTION_STR")
load_dotenv()
...
def insert():
    ...
    rag = GraphRAG(
        ...
        vector_db_storage_cls=AsyncPGVectorStorage,
        vector_db_storage_cls_kwargs={"dsn": dsn},
